...
export const INITIAL_ACTIVITY: ActivityItem[] = [
  ...
  },
  {
    ...
    action: 'UPDATED',
    resourceType: 'NOTE',
    resourceId: 'note_hnsw_vector_graph',
    resourceTitle: 'Hierarchical Navigable Small World (HNSW) Vector Indexing',
    timestamp: '2026-08-26T11:10:00Z',
    details: 'Added vector cosine similarity equations and cache alignment notes.',
  },
  {
    id: 'act_06',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'NOTE',
    resourceId: 'note_lumen_system',
    resourceTitle: 'Lumen System: High-Density Workspace Paradigms',
    timestamp: '2026-08-25T15:30:00Z',
    details: 'Authored design system specification and contrast ratios.',
  },
  {
    id: 'act_07',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'NOTE',
    resourceId: 'note_zero_trust_rbac',
    resourceTitle: 'Zero-Trust Role-Based Access Control Specification',
    timestamp: '2026-08-24T18:40:00Z',
    details: 'Defined cryptographically enforced session tokens and role hierarchies.',
  },
  {
    id: 'act_08',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'HIGHLIGHTED',
    resourceType: 'DOCUMENT',
    resourceId: 'doc_vector_index_spec',
    resourceTitle: 'HNSW Cache-Line Aligned SIMD Specification',
    timestamp: '2026-08-23T14:15:00Z',
    details: 'Highlighted AVX-512 distance calculations on page 2.',
  },
  {
    id: 'act_09',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'CODE',
    resourceId: 'code_lumen_token_theme',
    resourceTitle: 'Lumen Grid Dynamic CSS Custom Properties Injector',
    timestamp: '2026-08-22T10:00:00Z',
    details: 'Implemented nested border-radius calculation helper.',
  },
  {
    id: 'act_10',
    workspaceId: 'ws_eng_arch',
    ...
    resourceType: 'BOOKMARK',
    resourceId: 'bm_03',
    resourceTitle: 'Efficient and Robust Approximate Nearest Neighbor Using HNSW',
    timestamp: '2026-08-21T09:30:00Z',
    details: 'Saved arXiv research paper on graph indexing.',
  },
  {
    id: 'act_11',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Added SSR streaming diagrams and hydration boundary notes.',
  },
  {
    id: 'act_12',
    workspaceId: 'ws_eng_arch',
    ...
    resourceType: 'BOOKMARK',
    resourceId: 'bm_02',
    resourceTitle: 'OWASP Server-Side Request Forgery Prevention Cheat Sheet',
    timestamp: '2026-08-19T13:45:00Z',
    details: 'Documented defense guidelines against private IP range extraction.',
  },
  {
    id: 'act_13',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'CODE',
    resourceId: 'code_pagerank_sim',
    resourceTitle: 'PageRank Graph Centrality Scoring Algorithm',
    timestamp: '2026-08-18T11:00:00Z',
    details: 'Implemented power iteration with damping factor 0.85.',
  },
  {
    id: 'act_14',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Highlighted Raft state machine consensus invariants.',
  },
  {
    id: 'act_15',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Updated heuristic neighbor pruning equations.',
  },
  {
    id: 'act_16',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Initialized zero-trust documentation structure.',
  },
  {
    id: 'act_17',
    workspaceId: 'ws_eng_arch',
    ...
    resourceType: 'BOOKMARK',
    resourceId: 'bm_01',
    resourceTitle: 'React Server Components & Next.js App Router Paradigms',
    timestamp: '2026-08-12T14:30:00Z',
    details: 'Added official documentation link.',
  },
  {
    id: 'act_18',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Ingested 14-page architectural whitepaper PDF into vault.',
  },
  {
    id: 'act_19',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Initial draft of layout grid guidelines.',
  },
  {
    id: 'act_20',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Drafted performance benchmarks for server-side streaming.',
  },
  {
    id: 'act_21',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Created initial HNSW research note.',
  },
  {
    id: 'act_22',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Highlighted AVX memory alignment requirements.',
  },
  {
    id: 'act_23',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Created core Next.js architecture document.',
  },
  {
    id: 'act_24',
    workspaceId: 'ws_eng_arch',
    ...
    resourceId: 'col_lumen_design',
    resourceTitle: 'Lumen Grid Design System',
    timestamp: '2026-07-25T11:30:00Z',
    details: 'Created new research collection for design tokens.',
  },
  {
    id: 'act_25',
    workspaceId: 'ws_eng_arch',
    ...
    details: 'Ingested 8-page HNSW technical spec.',
  },
  {
    id: 'act_26',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'COLLECTION',
    resourceId: 'col_security_hardening',
    resourceTitle: 'Zero-Trust & Security',
    timestamp: '2026-07-15T10:00:00Z',
    details: 'Established security research workspace collection.',
  },
  {
    id: 'act_27',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'COLLECTION',
    resourceId: 'col_vector_graph',
    resourceTitle: 'Graph & Vector Indexing',
    timestamp: '2026-07-10T09:00:00Z',
    details: 'Initialized graph indexing research group.',
  },
  {
    id: 'act_28',
    workspaceId: 'ws_eng_arch',
    ...
    action: 'CREATED',
    resourceType: 'COLLECTION',
    resourceId: 'col_systems_arch',
    resourceTitle: 'Systems Architecture',
    timestamp: '2026-07-05T08:30:00Z',
    details: 'Provisioned Systems Architecture collection.',
  },
];
